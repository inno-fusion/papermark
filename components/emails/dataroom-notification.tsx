...
export default function DataroomNotification({
  ...
  url = "https://0xmetalabs.com/datarooms/123",
  unsubscribeUrl = "https://0xmetalabs.com/datarooms/123/unsubscribe",
}: {
  dataroomName: string;
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm text-gray-400">DocRoom by 0xMetaLabs</Text>
            ...
            <Section className="text-gray-400">
              ...
              <Text className="text-xs">
                ...
                DocRoom. If you have any feedback or questions about this email,
                simply reply to it. To unsubscribe from updates about this
                dataroom,{" "}
                <a
                  href={unsubscribeUrl}
