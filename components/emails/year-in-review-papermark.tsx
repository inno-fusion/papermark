          ...
          <Container className="mx-auto w-full max-w-[600px] p-0">
            <Section className="p-8 text-center">
              ...
              <Heading className="my-4 text-4xl font-medium leading-tight">
                Your Year with DocRoom
              </Heading>
              <Text className="mb-8 text-lg leading-8">
                What a year it&apos;s been! Let&apos;s take a look at how
                you&apos;ve used DocRoom to share your important documents.
              </Text>
            </Section>
            ...
            <Section className="pb-6 text-center">
              <Text className="text-xl leading-8 text-gray-900">
                ...
                Happy Holidays from the DocRoom team :)
              </Text>
              <Link
            ...
            <Section className="mt-8 text-gray-400">
              ...
              <Text className="text-xs">
                ...
                account with DocRoom during {year}. If you have any feedback or
