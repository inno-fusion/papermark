        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">
              We offer direct integration to Slack for document notifications.
            </Text>
            <Text className="text-sm">
              With our Slack integration, you can get real-time notifications
              about document and data room views directly in your Slack channels!
            </Text>
            ...
            <Text className="text-sm text-gray-400">The DocRoom Team</Text>
            <Hr />
            <Section className="mt-8 text-gray-400">
              ...
              <Text className="text-xs">
                Feel free to always reach out to our support team.
              </Text>
            </Section>
          </Container>
        </Body>
