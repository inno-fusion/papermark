    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-border bg-white px-4 py-4 pt-8 dark:border-gray-900 dark:bg-gray-900 sm:px-8">
        ...
        <DialogDescription>
          ...
          be reset to <span className="font-medium">{process.env.NEXT_PUBLIC_APP_DOMAIN || "docroom.io"}</span> links.
          This action cannot be undone.
          <div className="mt-3 text-sm font-medium text-foreground">
            {domain}{" "}
            <span className="text-muted-foreground">→ {process.env.NEXT_PUBLIC_APP_DOMAIN || "docroom.io"}</span>
          </div>
        </DialogDescription>
      </div>
